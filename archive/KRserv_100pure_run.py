...
space = {   'dropout1': hp.uniform('dropout1', .1,.6),
            ...
            'n_neuron1' : hp.choice('n_neuron1', [16, 32, 64, 128, 256, 512, 1024]),
            #'n_neuron2': hp.choice('n_neuron2', [16, 32, 128, 256, 512, 1024]),
            #'LR' : hp.choice('LR', 0.01, 0.00001),
            #'optimizer' : hp.choice('optimizer',['adadelta','adam','nadam']),
            'activation': hp.choice('activation',['relu','tanh','elu']),
            'use_BN' : hp.choice('use_BN', [True]),
...
from KRserv_100pure_obj import create_model

# trials = Trials()
# trials = pickle.load(open("myfile.p", "rb"))
trials = MongoTrials('mongo://localhost:1234/foo_db/jobs', exp_key='exp400')
