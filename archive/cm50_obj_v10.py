...
def data_preprocessing(val_test_size,
    ...
    df_down.to_pickle("C:\\Users\\johannes.heck\\Desktop\\model_output\\cm50_v10\\rules50.pkl")
    ...
    new_folder = "cm50_{}_".format(random_state) + time.strftime("%Y%m%d_%H%M%S")
    ...
    tokz = "C:\\Users\\johannes.heck\\Desktop\\model_output\\cm50_v10\\tokenizer.pickle"
    with open(tokz, 'rb') as handle:
        tokenizer = pickle.load(handle)

    # saving reversed label
    revlabel = "C:\\Users\\johannes.heck\\Desktop\\model_output\\cm50_v10\\reversed_label.pickle"
    ...
    return X_train, y_train, X_val, y_val, X_test, y_test, 498, output_dir
...
def create_model(X_train, y_train, X_val, y_val, X_test, y_test, num_classes, output_dir):
    ...
    print("\nLoaded model from cm50_v10...")
    model.load_weights("C:\\Users\\johannes.heck\\Desktop\\model_output\\cm50_v10\\model.hdf5")
    ...
    print([index for index,value in enumerate(FP) if value>=24])
    FN = conf.sum(axis=1) - np.diag(conf)
    print([index for index, value in enumerate(FN) if value >= 34])
    TP = np.diag(conf)
    TN = conf.sum() - (FP + FN + TP)

    print("\nFP")
    print("Label: {}, Count: {}" .format(reversed_label.get(conf_label[0]),FP[0]))
    print("Label: {}, Count: {}" .format(reversed_label.get(conf_label[57]),FP[57]))
    print("Label: {}, Count: {}" .format(reversed_label.get(conf_label[164]),FP[164]))

    print("\nFN")
    print("Label: {}, Count: {}" .format(reversed_label.get(conf_label[29]),FN[29]))
    print("Label: {}, Count: {}" .format(reversed_label.get(conf_label[57]),FN[57]))
    print("Label: {}, Count: {}" .format(reversed_label.get(conf_label[159]),FN[159]))
    ...
    df_rules = pd.read_pickle("C:\\Users\\johannes.heck\\Desktop\\model_output\\cm50_v10\\rules50.pkl")
    ...
    print([index for index, value in enumerate(FN) if value >= 90])
    TP = np.diag(conf_new)
    TN = conf_new.sum() - (FP + FN + TP)

    print("\nFP")
    print("Label: {}, Count: {}".format(conf_label[0], FP[0]))
    print("Label: {}, Count: {}".format((conf_label[57]), FP[57]))
    print("Label: {}, Count: {}".format((conf_label[164]), FP[164]))


    print("\nFN")
    print("Label: {}, Count: {}".format((conf_label[29]), FN[29]))
    print("Label: {}, Count: {}".format((conf_label[57]), FN[57]))
    print("Label: {}, Count: {}".format((conf_label[159]), FN[159]))
