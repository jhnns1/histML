...
output_dir = 'C:\\Users\\johannes.heck\\Desktop\\model_output'
...
# Vanilla GRU
model = Sequential()
model.add(Embedding(input_dim=max_features, output_dim=256))             # turns positive vectors into dense vectors (a la word2vec)
model.add((GRU(256, return_sequences=True)))
# model.add((GRU(256)))
model.add((GRU(256))) #, kernel_regularizer=regularizers.l2(0.01))))
model.add(Dense(num_classes, activation='softmax'))

print(model.summary())

# Compile the model = configuration of training process
# add to keras 2.0 more metrices: https://github.com/keras-team/keras/blob/53e541f7bf55de036f4f5641bd2947b96dd8c4c3/keras/metrics.py
# w/ beta <1, assigning the correct classes becomes more important, w/ beta > 1 penalizing incorrect class assignments
# set beta in metrics.py, call it via incorrect metric call
# currently: beta = 3
# WARNING: JUST BATCHWISE CALCULATION!

# # Loading a checked model
# model.load_weights("<name-of-the-weights.hdf5")
# # skip training!
...
score, acc, cat_acc, fb, f1 = model.evaluate(X_test,
                                         y_test,
                                         batch_size=batch_size)
