...
def create_model(X_train, y_train, X_val, y_val, X_test, y_test, num_classes, random_state):
    ...
    model.load_weights("C:\\Users\\johannes.heck\\Desktop\\model_output\\combined_50_0_20181221_120133\\model.hdf5")
