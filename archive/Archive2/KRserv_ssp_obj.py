...
def data_preprocessing(test_size,
    ...
    # print(df[df['label']=='minority_class'])
...
X_train, y_train, X_test, y_test, num_classes = data_preprocessing(0.2,
                                                                   80)
...
def create_model(params):
    ...
    adam_ = Adam(lr=0.001, clipnorm=1.)
    ...
    rs = ShuffleSplit(n_splits=int(params['epochs']), test_size=0.2, random_state=0)
    i = 0
