...
def data_preprocessing(min_count_per_class,
    ...
    df_['label2'] = df_['label']
    print("\nEstablished label 'minority_class'")
    df_['label2'][df_['counts'] < 100] = 'minority_class'
    df = df_
    ...
    print('\Oversampling + Undersampling combined w/ SMOTETomek...')
    sm = SMOTETomek(sampling_strategy='not majority', random_state=13)
