...
from bm_debug import create_model, data_preprocessing

X_train, y_train, X_val, y_val, X_test, y_test, num_classes, reverse_word_map = data_preprocessing(6,
                                                                                 0.3,
                                                                                 0.5,
                                                                                 80,
                                                                                 set_custom_n=True,
...
model = create_model(X_train, y_train, X_val, y_val, X_test, y_test,num_classes,reverse_word_map)
