...
# Parameters
from Patty_smote_bm import config_
...
from Patty_smote_bm import create_model
...
space = {   'dropout1': hp.uniform('dropout1', .1,.6),
            ...
            'n_neuron1' : hp.choice('n_neuron1', [32, 128, 256, 512, 1024]),
            'n_neuron2': hp.choice('n_neuron2', [32, 128, 256, 512, 1024]),
...
json_ = output_dir + 'trials_losses.json'   # includes the best lost
with open(json_,'w') as fp:
