...
if platform =="win32" or platform=="cygwin":
    ...
    print('\nPlease provide the path/to/file for this linux machine')
else:
    print('\nCould not recognize the operating platform. Please provide the path/to/file and tune this if statement')
    sys.exit(0)
...
model.compile(loss='categorical_crossentropy',
              optimizer='adam',
              metrics=['categorical_accuracy','fbeta_score','fmeasure','acc'])
...
print("Test accuracy measure:", acc)
